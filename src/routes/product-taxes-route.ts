  ...
  .get(
    ...
    async ({ params, set, headers }) => {
      ...
      try {
        ...
        const result = await getProductTaxByVariantId(params.variantId);
        return { data: result };
      } catch (error: any) {
        if (error.message === 'Unauthorized') {
          set.status = 401;
  ...
  .patch(
    ...
    async ({ params, body, set, headers }) => {
      ...
      try {
        ...
        const result = await updateProductTax(
          params.id,
          body as Partial<CreateProductTaxData>
        );
        return { data: result };
      } catch (error: any) {
        if (error.message === 'Unauthorized') {
  ...
  .delete(
    ...
    async ({ params, set, headers }) => {
      ...
      try {
        ...
        await deleteProductTax(params.id);
        return { data: 'OK' };
      } catch (error: any) {
        if (error.message === 'Unauthorized') {
          set.status = 401;
